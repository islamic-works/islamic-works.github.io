...
Me ajude a manter este trabalho e melhorar os plugins, com as doações, poderei dar mais suporte, atenção a um maior número de pessoas, e ainda fazer algum plugin/módulo/componente de exemplo a pedidos.
...
Autor no Wiki: خالد حسني (previous version Baba66) - Obra do próprio

## Site baseado no projeto: Galada - Easy & Simple Theme for Personal Blog
...
Add post images to **/assets/images/** directory.
